...
#define STRING_CONFIG_H_AUTHOR "(james-fry)" // Who made the changes.
 ...
 */
#define X_DRIVER_TYPE PRUSA_AIO_XY_DRIVER_TYPE
#define Y_DRIVER_TYPE PRUSA_AIO_XY_DRIVER_TYPE
#define Z_DRIVER_TYPE PRUSA_AIO_Z_DRIVER_TYPE
