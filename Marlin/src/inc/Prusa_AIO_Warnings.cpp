...
#define PRUSA_AIO_VERSION 20220604
 ...
 */
  ...
  // Remind users to set driver jumpers correctly when mixing drivers
  #if EITHER(PRUSA_AIO_DRIVERS_TMC5160_XY, PRUSA_AIO_DRIVERS_TMC5160_Z) && NONE(PRUSA_AIO_MOTHERBOARD_BTT_SKR_V3_0_EZ, PRUSA_AIO_MOTHERBOARD_BTT_SKR_V3_0)
    #warning "Ensure Extruder driver jumpers are set to UART mode."

    #if ENABLED(PRUSA_AIO_DRIVERS_TMC5160_XY) && NONE(PRUSA_AIO_MOTHERBOARD_BTT_SKR_V3_0_EZ, PRUSA_AIO_MOTHERBOARD_BTT_SKR_V3_0)
      #warning "Ensure X & Y driver jumpers are set to SPI mode."
    #endif

    #if ENABLED(PRUSA_AIO_DRIVERS_TMC5160_Z) && NONE(PRUSA_AIO_MOTHERBOARD_BTT_SKR_V3_0_EZ, PRUSA_AIO_MOTHERBOARD_BTT_SKR_V3_0)
      #warning "Ensure Z driver jumpers are set to SPI mode."
    #endif
  #endif

  // Remind users of common LCD controller setup issues
  #warning "If your LCD does not light up, you may need to rotate cables 180° on one end."
