...
// Dual Z driver
  ...
  #define SDCARD_CONNECTION ONBOARD  // JF - also change in Configuration_adv.h
...
#if DISABLED(PRUSA_AIO_DRIVERS_TMC5160_XY)
  #define PRUSA_AIO_XY_DRIVER_TYPE TMC2209
  #define PRUSA_AIO_XY_ENDSTOP_INVERTING false
  #define PRUSA_AIO_DRIVER_RSENSE 0.11
#else
  #define PRUSA_AIO_XY_DRIVER_TYPE TMC5160
  #define PRUSA_AIO_XY_ENDSTOP_INVERTING true
  #define PRUSA_AIO_DRIVER_RSENSE 0.075
  #define TMC_USE_SW_SPI
#endif

#if DISABLED(PRUSA_AIO_DRIVERS_TMC5160_Z)
  #define PRUSA_AIO_Z_DRIVER_TYPE TMC2209
  #define PRUSA_AIO_DRIVER_RSENSE 0.11
#else
  #define PRUSA_AIO_Z_DRIVER_TYPE TMC5160
  #define PRUSA_AIO_DRIVER_RSENSE 0.075
  #define TMC_USE_SW_SPI
#endif
...
#if DISABLED(PRUSA_AIO_MOTHERBOARD_BTT_SKR_MINI_E3_V3)
  #define ADAPTIVE_STEP_SMOOTHING // Adaptive Step Smoothing can cause leveling issues on BTT_SKR_MINI_E3_V3
#endif
...
// Final Extruder Inverting
#if EITHER(PRUSA_AIO_INVERT_E_DIR, PRUSA_AIO_INVERT_E_DIR_DEFAULT) && (INVERT_E0_DIR == true)
  #undef INVERT_E0_DIR  // Prevent redefined warnings
  #define INVERT_E0_DIR false
#elif EITHER(PRUSA_AIO_INVERT_E_DIR, PRUSA_AIO_INVERT_E_DIR_DEFAULT) && (INVERT_E0_DIR == false)
  #undef INVERT_E0_DIR  // Prevent redefined warnings
  #define INVERT_E0_DIR true
#endif
...
// Hotend Cooling Fan
  ...
  // No FAN1_PIN availble. Connect hotend cooling fan directly to 24V power source.
...
#elif ENABLED(PRUSA_AIO_PART_COOLING_FAN_24V_MECHATRONICS_B5015E24B_BSR)
...
//===========================================================================
   ...
   */
    ...
    #define NEOPIXEL2_PIN EXP1_05_PIN
